...
import { subscribeToOrders, updateOrder } from '../api/orderingSocket';
...
export class WorkerView extends Component {
    ...
    setOrderStatus(order, status) {
        ...
        this.setState(prevState => ({
            orders: prevState.orders.map(o => (o === order ? updatedOrder : o))
        }));
    ...
    render() {
        ...
        const currentOrder =
            currentOrderId != null && orders.find(order => order.id === currentOrderId);
                ...
                <Grid container>
                    <Grid item sm={6}>
                        ...
                        <OrderList
                            ...
                            onSetCurrentOrder={this.setCurrentOrder}
                        />
                        <h2>Complete</h2>
                        <OrderList
